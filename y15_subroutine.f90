...
IMPLICIT NONE
CONTAINS
SUBROUTINE mod5c(theta,time,climate,init,b,d,leac,xt)
IMPLICIT NONE
    !********************************************* &
...
SUBROUTINE yasso15(theta,time,climate,init,b,d,leac,xt)
  USE yasso
  IMPLICIT NONE
  !********************************************* &
  ! GENERAL DESCRIPTION FOR ALL THE MEASUREMENTS
  ...
  CALL mod5c(theta,time,climate,init,b,d,leac,xt)
END SUBROUTINE yasso15
