!The only change for the monthly time step experiment is
!in the line 39. The loop is replaced by single call to exponent function
!#define REAL DOUBLE PRECISION
SUBROUTINE yasso07month(a,t,cl,init,inf,s,z) !components separately
  IMPLICIT NONE
  !*********************************************
  ...
  DOUBLE PRECISION,DIMENSION(45),INTENT(IN) :: a !parameters
  DOUBLE PRECISION,INTENT(IN) :: t,s !time,size
  DOUBLE PRECISION,DIMENSION(3),INTENT(IN) :: cl !climatic conditions
  DOUBLE PRECISION,DIMENSION(5),INTENT(IN) :: init
  DOUBLE PRECISION,DIMENSION(5),INTENT(IN) :: inf !infall
  DOUBLE PRECISION,DIMENSION(5),INTENT(OUT) :: z
  DOUBLE PRECISION,DIMENSION(5,5) :: m,mt,m2,mi
  INTEGER :: i
  ...
  tem=EXP(a(17)*cl(1)+a(18)*cl(3)**2.0)
...
CONTAINS
  ...
  SUBROUTINE matrixexp(a,b)
    ...
    DOUBLE PRECISION,DIMENSION(5,5) :: c,d
